...
import 'package:cola/src/command_runner.dart';
...
void main() {
  group('ColaCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late ColaCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = ColaCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = ColaCommandRunner();
